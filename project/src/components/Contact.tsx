                ...
                <form onSubmit={handleSubmit} className="space-y-6 animate-fade-in">
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <input
                        ...
                        required
                        className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-cyan-500 focus:border-transparent transition-all duration-300 hover:border-cyan-300"
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      required
                      rows={5}
                      className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-cyan-500 focus:border-transparent transition-all duration-300 resize-vertical hover:border-cyan-300"
                  ...
                  <div className="flex items-center space-x-3">
                    <input
                      ...
                      onChange={handleInputChange}
                      className="w-5 h-5 text-cyan-600 focus:ring-cyan-500 border-gray-300 rounded transition-all duration-300"
                    />
                  ...
                  <button
                    type="submit"
                    className="w-full bg-cyan-500 text-white py-4 px-6 rounded-lg font-semibold hover:bg-cyan-600 transition-all duration-300 flex items-center justify-center space-x-2 shadow-lg hover:shadow-xl hover:-translate-y-1 hover-glow"
                  >
